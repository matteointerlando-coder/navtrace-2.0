...
export default defineConfig((/* ctx */) => {
  return {
    ...
    devServer: {
      // https: true,
      port: 9200,  //l'ho aggiunto io sennò andava in 9000!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      open: true, // opens browser window automatically

      //l'ho aggiunto io 
      proxy: {
        // proxy all requests starting with /api to our Spring Boot backend
        '/api': {
          target: 'http://localhost:3000', // indirizzo del backend Spring Boot
          changeOrigin: false,
        }
      }
    },
